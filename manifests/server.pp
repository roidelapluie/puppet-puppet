...
#                              type:boolean
#
# $passenger_max_pool::        The PassengerMaxPoolSize parameter. If your
...
#                              type:boolean
#
# $lenses_dir::                The path of the augeas lenses directory
#                              type:string
#
...
class puppet::server(
  ...
  $lenses_dir               = $::puppet::server_lenses_dir,
  ...
  if $implementation == 'puppetserver' {
    ...
    validate_absolute_path($lenses_dir)
  ...
  $ssl_cert      = "${ssl_dir}/certs/${lower_fqdn}.pem"
  $ssl_cert_key  = "${ssl_dir}/private_keys/${lower_fqdn}.pem"
